...
public class DialogPause extends AlertDialog {
    ...
    private void loadView() {
        btnPlay = findViewById(R.id.play_btn_dialog_stop);
        score = findViewById(R.id.score_tv_stop_dialog);
        time = findViewById(R.id.time_tv_dialog_stop);
    }
